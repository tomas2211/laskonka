...
public class Bmp180SensorDriver implements AutoCloseable {
    ...
    /*public void registerBarometerSensor() {
        ...
        if (mBarometerUserDriver == null) {
            ...
            UserDriverManager.getInstance().registerSensor(mBarometerUserDriver);
        }
    }*/
    ...
    UserSensorDriver mPressureUserDriver = new UserSensorDriver() {
        // DRIVER parameters
        // documented at https://source.android.com/devices/sensors/hal-interface.html#sensor_t
...
//                        .setMaxDelay(DRIVER_MAX_DELAY_US)
    ...
    UserSensorDriver mBarometerUserDriver = new UserSensorDriver() {
...
//                        .setRequiredPermission(DRIVER_REQUIRED_PERMISSION)
    ...
    UserSensorDriver mTemperatureUserDriver = new UserSensorDriver() {
        // DRIVER parameters
        // documented at https://source.android.com/devices/sensors/hal-interface.html#sensor_t
